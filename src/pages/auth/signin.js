...
import {Button, Segment, Modal, Form, Grid, Icon, Message} from 'semantic-ui-react';
import "./auth.css";
        ...
        <Grid style={{minHeight: '100vh'}}>
            ...
            >
                <Modal.Header> <FontAwesomeIcon className='logo' icon={faHeadphonesSimple} size="2x"
                                                style={{paddingRight: '10px'}}/><span> Login to MusicApp</span></Modal.Header>
                <Modal.Content>
                    ...
                    {isAuthed
                        ?
                        <Message success header='You have successfully signed in.' content='Discover new artists at the top navigation.'></Message>
                        : <Form onSubmit={verifyAccount}>
                            ...
                            <Grid centered columns={1}>
                                ...
                                <Grid.Column>
                                    <Button className='form-btn' fluid size='small' type="submit"
