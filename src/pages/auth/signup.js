...
Date: 6/10/2022
File: signout.js
Description: This script allows user to sign-up for a new account
*/
...
import "./auth.css";
import {Form, Grid, Icon, Message, Modal, Segment, Button} from 'semantic-ui-react'
    ...
    return (
        <Grid style={{minHeight: '100vh'}}>
            <Modal onClose={handleOnClose}
                   ...
                   size='mini'
            >
                <Modal.Header><FontAwesomeIcon className='logo' icon={faHeadphonesSimple} size="2x"
                                               style={{paddingRight: '10px'}}/><span> Create an Account</span></Modal.Header>
                <Modal.Content>
                    ...
                    {isAuthed
                        ?
                        <Message success header='Your account has been created.' content='Click the links
                                in the navbar to explore the app.'></Message>
                        : <Form onSubmit={createAccount}>
                            ...
                            <Grid centered columns={1}>
                                ...
                                <Grid.Column>
                                    <Button fluid size='small' type="submit" color='green'>Create Account</Button>
                                </Grid.Column>
